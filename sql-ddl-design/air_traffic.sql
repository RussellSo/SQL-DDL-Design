...
-- ERROr: Im creating Tickets table and realized I should have made abbreviations for cities and countries as the serial key instead of Integers to make things easier.
